...
main()
{
	...
	q = meanc(mx[0:][0]-0.00038584*constant-0.24851*lag0(mx[0:][],1)-0.16149*lag0(mx[0:][],2)+0.016108*lag0(mx[0:][],3)-0.063597*lag0(mx[0:][],4)-0.041309*lag0(mx[0:][],5)+0.0031660*lag0(mx[0:][],6)-0.079197*lag0(mx[0:][],7)-0.045816*lag0(mx[0:][],8)-0.12962*lag0(mx[0:][],9)+0.034190*lag0(mx[0:][],10)-0.059973*lag0(mx[0:][],11)-0.12447*lag0(mx[0:][],12));
		
	U = (mx[0:][0]-0.00038584*constant-0.24851*lag0(mx[0:][],1)-0.16149*lag0(mx[0:][],2)+0.016108*lag0(mx[0:][],3)-0.063597*lag0(mx[0:][],4)-0.041309*lag0(mx[0:][],5)+0.0031660*lag0(mx[0:][],6)-0.079197*lag0(mx[0:][],7)-0.045816*lag0(mx[0:][],8)-0.12962*lag0(mx[0:][],9)+0.034190*lag0(mx[0:][],10)-0.059973*lag0(mx[0:][],11)-0.12447*lag0(mx[0:][],12)-q);
	...
	for (j = 0; j<476; ++j)
	{
	s[j+12]= 0.00038584+0.24851*s[j+11]+0.16149*s[j+10]-0.016108*s[j+9]+0.063597*s[j+8]+0.041309*s[j+7]-0.0031660*s[j+6]+0.079197*s[j+5]+0.045816*s[j+4]+0.12962*s[j+3]-0.034190*s[j+2]+0.059973*s[j+1]+0.12447*s[j]+P1[j+12];
	}																																			
	...
	savemat("G:\BOOTDATAAR.US.in7",mresults');
