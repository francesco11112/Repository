...
main()
{
	...
	q = meanc(mx[0:][0]-0.0024855*constant+0.068512*lag0(mx[0:][],1)-0.058245*lag0(mx[0:][],2)-0.29251*lag0(mx[0:][],3)-0.081822*lag0(mx[0:][],4)-0.12923*lag0(mx[0:][],5)-0.10079*lag0(mx[0:][],6)+0.00088477*lag0(mx[0:][],7)-0.019275*lag0(mx[0:][],8)-0.014619*lag0(mx[0:][],9)-0.0028229*lag0(mx[0:][],10)-0.029713*lag0(mx[0:][],11)-0.17300*lag0(mx[0:][],12));
		
	U = (mx[0:][0]-0.0024855*constant+0.068512*lag0(mx[0:][],1)-0.058245*lag0(mx[0:][],2)-0.29251*lag0(mx[0:][],3)-0.081822*lag0(mx[0:][],4)-0.12923*lag0(mx[0:][],5)-0.10079*lag0(mx[0:][],6)+0.00088477*lag0(mx[0:][],7)-0.019275*lag0(mx[0:][],8)-0.014619*lag0(mx[0:][],9)-0.0028229*lag0(mx[0:][],10)-0.029713*lag0(mx[0:][],11)-0.17300*lag0(mx[0:][],12)-q);
	...
	for (j = 0; j<476; ++j)
	{
	s[j+12]= 0.0024855-0.068512*s[j+11]+0.058245*s[j+10]+0.29251*s[j+9]+0.081822*s[j+8]+0.12923*s[j+7]+0.10079*s[j+6]-0.00088477*s[j+5]+0.019275*s[j+4]+0.014619*s[j+3]+0.0028229*s[j+2]+0.029713*s[j+1]+0.17300*s[j]+P1[j+12];
	}																																			
	...
	savemat("G:\BOOTDATAAR.ICE.in7",mresults');
