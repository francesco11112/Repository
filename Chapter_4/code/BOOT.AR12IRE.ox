...
main()
{
	...
	q = meanc(mx[0:][0]- 0.00036582*constant-0.68713*lag0(mx[0:][],1)-0.085999*lag0(mx[0:][],2)+0.25854*lag0(mx[0:][],3)-0.15959*lag0(mx[0:][],4)+0.015185*lag0(mx[0:][],5)+0.059700*lag0(mx[0:][],6)-0.053811*lag0(mx[0:][],7)-0.037804*lag0(mx[0:][],8)-0.10153*lag0(mx[0:][],9)-0.010692*lag0(mx[0:][],10)+0.092571*lag0(mx[0:][],11)-0.23200*lag0(mx[0:][],12));
		
	U = (mx[0:][0]- 0.00036582*constant-0.68713*lag0(mx[0:][],1)-0.085999*lag0(mx[0:][],2)+0.25854*lag0(mx[0:][],3)-0.15959*lag0(mx[0:][],4)+0.015185*lag0(mx[0:][],5)+0.059700*lag0(mx[0:][],6)-0.053811*lag0(mx[0:][],7)-0.037804*lag0(mx[0:][],8)-0.10153*lag0(mx[0:][],9)-0.010692*lag0(mx[0:][],10)+0.092571*lag0(mx[0:][],11)-0.23200*lag0(mx[0:][],12)-q);
	...
	for (j = 0; j<476; ++j)
	{
	s[j+12]= 0.00036582+0.68713*s[j+11]+0.085999*s[j+10]-0.25854*s[j+9]+0.15959*s[j+8]-0.015185*s[j+7]-0.059700*s[j+6]+0.053811*s[j+5]+0.037804*s[j+4]+0.10153*s[j+3]+0.010692*s[j+2]-0.092571*s[j+1]+0.23200*s[j]+P1[j+12];
	}																																			
	...
	savemat("G:\BOOTDATAAR.IRE.in7",mresults');
