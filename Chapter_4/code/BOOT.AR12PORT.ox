...
main()
{
	...
	q = meanc(mx[0:][0]-0.0025107*constant-0.079310*lag0(mx[0:][],1)-0.0030414*lag0(mx[0:][],2)-0.089959*lag0(mx[0:][],3)-0.011598*lag0(mx[0:][],4)-0.023484*lag0(mx[0:][],5)-0.085748*lag0(mx[0:][],6)-0.042689*lag0(mx[0:][],7)-0.0072577*lag0(mx[0:][],8)-0.067851*lag0(mx[0:][],9)-0.044742*lag0(mx[0:][],10)-0.072674*lag0(mx[0:][],11)-0.16928*lag0(mx[0:][],12));
		
	U = (mx[0:][0]-0.0025107*constant-0.079310*lag0(mx[0:][],1)-0.0030414*lag0(mx[0:][],2)-0.089959*lag0(mx[0:][],3)-0.011598*lag0(mx[0:][],4)-0.023484*lag0(mx[0:][],5)-0.085748*lag0(mx[0:][],6)-0.042689*lag0(mx[0:][],7)-0.0072577*lag0(mx[0:][],8)-0.067851*lag0(mx[0:][],9)-0.044742*lag0(mx[0:][],10)-0.072674*lag0(mx[0:][],11)-0.16928*lag0(mx[0:][],12)-q);
	...
	for (j = 0; j<476; ++j)
	{
	s[j+12]= 0.0025107+0.079310*s[j+11]+0.0030414*s[j+10]+0.089959*s[j+9]+0.011598*s[j+8]+0.023484*s[j+7]+0.085748*s[j+6]+0.042689*s[j+5]+0.0072577*s[j+4]+0.067851*s[j+3]+0.044742*s[j+2]+0.072674*s[j+1]+0.16928*s[j]+P1[j+12];
	}																																			
	...
	savemat("G:\BOOTDATAAR.PORT.in7",mresults');
