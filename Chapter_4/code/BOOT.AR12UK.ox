...
main()
{
	...
	q = meanc(mx[0:][0]- 0.00059700*constant-0.25342*lag0(mx[0:][],1)-0.080573*lag0(mx[0:][],2)-0.047072*lag0(mx[0:][],3)+0.012858*lag0(mx[0:][],4)-0.043619*lag0(mx[0:][],5)-0.14403*lag0(mx[0:][],6)+0.062547*lag0(mx[0:][],7)+0.016052*lag0(mx[0:][],8)+0.033191*lag0(mx[0:][],9)-0.011014*lag0(mx[0:][],10)+0.050636*lag0(mx[0:][],11)-0.48978*lag0(mx[0:][],12));
		
	U = (mx[0:][0]- 0.00059700*constant-0.25342*lag0(mx[0:][],1)-0.080573*lag0(mx[0:][],2)-0.047072*lag0(mx[0:][],3)+0.012858*lag0(mx[0:][],4)-0.043619*lag0(mx[0:][],5)-0.14403*lag0(mx[0:][],6)+0.062547*lag0(mx[0:][],7)+0.016052*lag0(mx[0:][],8)+0.033191*lag0(mx[0:][],9)-0.011014*lag0(mx[0:][],10)+0.050636*lag0(mx[0:][],11)-0.48978*lag0(mx[0:][],12)-q);
	...
	for (j = 0; j<476; ++j)
	{
	s[j+12]= 0.00059700+0.25342*s[j+11]+0.080573*s[j+10]+0.047072*s[j+9]-0.012858*s[j+8]+0.043619*s[j+7]+0.14403*s[j+6]-0.062547*s[j+5]-0.016052*s[j+4]-0.033191*s[j+3]+0.011014*s[j+2]-0.050636*s[j+1]+0.48978*s[j]+P1[j+12];
	}																																			
	...
	savemat("G:\BOOTDATAAR.UK.in7",mresults');
