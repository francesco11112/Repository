...
main()
{
	...
	q = meanc(mx[0:][0]- 0.00042501*constant-0.45344*lag0(mx[0:][],1)-0.013848*lag0(mx[0:][],2)-0.039587*lag0(mx[0:][],3)-0.10939*lag0(mx[0:][],4)+0.050668*lag0(mx[0:][],5)-0.12374*lag0(mx[0:][],6)-0.045142*lag0(mx[0:][],7)-0.026214*lag0(mx[0:][],8)-0.0059247*lag0(mx[0:][],9)+0.019719*lag0(mx[0:][],10)+0.020772*lag0(mx[0:][],11)-0.20693*lag0(mx[0:][],12));
		
	U = (mx[0:][0]- 0.00042501*constant-0.45344*lag0(mx[0:][],1)-0.013848*lag0(mx[0:][],2)-0.039587*lag0(mx[0:][],3)-0.10939*lag0(mx[0:][],4)+0.050668*lag0(mx[0:][],5)-0.12374*lag0(mx[0:][],6)-0.045142*lag0(mx[0:][],7)-0.026214*lag0(mx[0:][],8)-0.0059247*lag0(mx[0:][],9)+0.019719*lag0(mx[0:][],10)+0.020772*lag0(mx[0:][],11)-0.20693*lag0(mx[0:][],12)-q);
	...
	for (j = 0; j<476; ++j)
	{
	s[j+12]= 0.00042501+0.45344*s[j+11]+0.013848*s[j+10]+0.039587*s[j+9]+0.10939*s[j+8]-0.050668*s[j+7]+0.12374*s[j+6]+0.045142*s[j+5]+0.026214*s[j+4]+0.0059247*s[j+3]-0.019719*s[j+2]-0.020772*s[j+1]+0.20693*s[j]+P1[j+12];
	}																																			
	...
	savemat("G:\BOOTDATAAR.ITA.in7",mresults');
