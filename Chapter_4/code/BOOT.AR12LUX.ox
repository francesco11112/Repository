...
main()
{
	...
	q = meanc(mx[0:][0]- 0.00056072*constant-0.021879*lag0(mx[0:][],1)-0.056954*lag0(mx[0:][],2)-0.077862*lag0(mx[0:][],3)-0.067771*lag0(mx[0:][],4)+0.032995*lag0(mx[0:][],5)-0.17618*lag0(mx[0:][],6)+0.024667*lag0(mx[0:][],7)-0.046794*lag0(mx[0:][],8)-0.083428*lag0(mx[0:][],9)-0.030126*lag0(mx[0:][],10)-0.017494*lag0(mx[0:][],11)-0.31410*lag0(mx[0:][],12));
		
	U = (mx[0:][0]- 0.00056072*constant-0.021879*lag0(mx[0:][],1)-0.056954*lag0(mx[0:][],2)-0.077862*lag0(mx[0:][],3)-0.067771*lag0(mx[0:][],4)+0.032995*lag0(mx[0:][],5)-0.17618*lag0(mx[0:][],6)+0.024667*lag0(mx[0:][],7)-0.046794*lag0(mx[0:][],8)-0.083428*lag0(mx[0:][],9)-0.030126*lag0(mx[0:][],10)-0.017494*lag0(mx[0:][],11)-0.31410*lag0(mx[0:][],12)-q);
	...
	for (j = 0; j<476; ++j)
	{
	s[j+12]= 0.00056072+0.021879*s[j+11]+0.056954*s[j+10]+0.077862*s[j+9]+0.067771*s[j+8]-0.032995*s[j+7]+0.17618*s[j+6]-0.024667*s[j+5]+0.046794*s[j+4]+0.083428*s[j+3]+0.030126*s[j+2]+0.017494*s[j+1]+0.31410*s[j]+P1[j+12];
	}																																			
	...
	savemat("G:\BOOTDATAAR.LUX.in7",mresults');
