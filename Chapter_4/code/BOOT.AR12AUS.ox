...
main()
{
	decl salt,amxtxinv,XX,YY,x,w,d,b,c,U,P1,X,q,z,j,y,t,i,e,test,UR;
	decl res1,res2,res3,res4,q2,t2,t3,t4,res5,res6,R,R2,DW,Fstat1,Fstat2,Fstat,pval1,pval2;
	...
	q = meanc(mx[0:][0]-0.0013101*constant-0.075730*lag0(mx[0:][],1)+0.056273*lag0(mx[0:][],2)-0.0046351*lag0(mx[0:][],3)+0.12308*lag0(mx[0:][],4)-0.056531*lag0(mx[0:][],5)+0.0082101*lag0(mx[0:][],6)-0.091635*lag0(mx[0:][],7)+0.067675*lag0(mx[0:][],8)-0.00829188*lag0(mx[0:][],9)-0.021247*lag0(mx[0:][],10)-0.087202*lag0(mx[0:][],11)-0.51295*lag0(mx[0:][],12));
		
	U = (mx[0:][0]-0.0013101*constant-0.075730*lag0(mx[0:][],1)+0.056273*lag0(mx[0:][],2)-0.0046351*lag0(mx[0:][],3)+0.12308*lag0(mx[0:][],4)-0.056531*lag0(mx[0:][],5)+0.0082101*lag0(mx[0:][],6)-0.091635*lag0(mx[0:][],7)+0.067675*lag0(mx[0:][],8)-0.00829188*lag0(mx[0:][],9)-0.021247*lag0(mx[0:][],10)-0.087202*lag0(mx[0:][],11)-0.51295*lag0(mx[0:][],12)-q);
	...
	for (j = 0; j<476; ++j)
	{
	s[j+12]= 0.0013101+0.075730*s[j+11]-0.056273*s[j+10]+0.0046351*s[j+9]-0.12308*s[j+8]+0.056531*s[j+7]-0.0082101*s[j+6]+0.091635*s[j+5]-0.067675*s[j+4]+0.00829188*s[j+3]+0.021247*s[j+2]+0.087202*s[j+1]+0.51295*s[j]+P1[j+12];
	}																																			
	...
	savemat("G:\BOOTDATAAR.AUS.in7",mresults');
