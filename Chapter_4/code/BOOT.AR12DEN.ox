...
main()
{
	...
	q = meanc(mx[0:][0]- 0.0012451*constant-0.082917*lag0(mx[0:][],1)-0.045986*lag0(mx[0:][],2)+0.016693*lag0(mx[0:][],3)-0.033316*lag0(mx[0:][],4)+0.040508*lag0(mx[0:][],5)-0.28552*lag0(mx[0:][],6)+0.021244*lag0(mx[0:][],7)-0.066915*lag0(mx[0:][],8)-0.10311*lag0(mx[0:][],9)+0.014176*lag0(mx[0:][],10)-0.057273*lag0(mx[0:][],11)-0.15732*lag0(mx[0:][],12));
		
	U = (mx[0:][0]- 0.0012451*constant-0.082917*lag0(mx[0:][],1)-0.045986*lag0(mx[0:][],2)+0.016693*lag0(mx[0:][],3)-0.033316*lag0(mx[0:][],4)+0.040508*lag0(mx[0:][],5)-0.28552*lag0(mx[0:][],6)+0.021244*lag0(mx[0:][],7)-0.066915*lag0(mx[0:][],8)-0.10311*lag0(mx[0:][],9)+0.014176*lag0(mx[0:][],10)-0.057273*lag0(mx[0:][],11)-0.15732*lag0(mx[0:][],12)-q);
	...
	for (j = 0; j<476; ++j)
	{
	s[j+12]= 0.0012451+0.082917*s[j+11]+0.045986*s[j+10]-0.016693*s[j+9]+0.033316*s[j+8]-0.040508*s[j+7]+0.28552*s[j+6]-0.021244*s[j+5]+0.066915*s[j+4]+0.10311*s[j+3]-0.014176*s[j+2]+0.057273*s[j+1]+0.15732*s[j]+P1[j+12];
	}																																			
	...
	savemat("G:\BOOTDATAAR.DEN.in7",mresults');
