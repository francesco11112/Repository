...
main()
{
	...
	q = meanc(mx[0:][0]- 0.0010403*constant+0.010669*lag0(mx[0:][],1)-0.064540*lag0(mx[0:][],2)-0.074305*lag0(mx[0:][],3)-0.0058013*lag0(mx[0:][],4)+0.045605*lag0(mx[0:][],5)-0.13112*lag0(mx[0:][],6)-0.010039*lag0(mx[0:][],7)-0.061553*lag0(mx[0:][],8)-0.0096054*lag0(mx[0:][],9)+0.017746*lag0(mx[0:][],10)-0.057277*lag0(mx[0:][],11)-0.43775*lag0(mx[0:][],12));
		
	U = (mx[0:][0]- 0.0010403*constant+0.010669*lag0(mx[0:][],1)-0.064540*lag0(mx[0:][],2)-0.074305*lag0(mx[0:][],3)-0.0058013*lag0(mx[0:][],4)+0.045605*lag0(mx[0:][],5)-0.13112*lag0(mx[0:][],6)-0.010039*lag0(mx[0:][],7)-0.061553*lag0(mx[0:][],8)-0.0096054*lag0(mx[0:][],9)+0.017746*lag0(mx[0:][],10)-0.057277*lag0(mx[0:][],11)-0.43775*lag0(mx[0:][],12)-q);
	...
	for (j = 0; j<476; ++j)
	{
	s[j+12]= 0.0010403-0.010669*s[j+11]+0.064540*s[j+10]+0.074305*s[j+9]+0.0058013*s[j+8]-0.045605*s[j+7]+0.13112*s[j+6]+0.010039*s[j+5]+0.061553*s[j+4]+0.0096054*s[j+3]-0.017746*s[j+2]+ 0.057277*s[j+1]+0.43775*s[j]+P1[j+12];
	}																																			
	...
	savemat("G:\BOOTDATAAR.NOR.in7",mresults');
