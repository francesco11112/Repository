...
main()
{
	...
	q = meanc(mx[0:][0]- 0.00091974*constant+0.094583*lag0(mx[0:][],1)-0.030643*lag0(mx[0:][],2)+0.0054611*lag0(mx[0:][],3)+0.0095873*lag0(mx[0:][],4)-0.012714*lag0(mx[0:][],5)-0.061877*lag0(mx[0:][],6)-0.082968*lag0(mx[0:][],7)-0.12397*lag0(mx[0:][],8)-0.045143*lag0(mx[0:][],9)+0.018807*lag0(mx[0:][],10)-0.12487*lag0(mx[0:][],11)-0.25863*lag0(mx[0:][],12));
		
	U = (mx[0:][0]- 0.00091974*constant+0.094583*lag0(mx[0:][],1)-0.030643*lag0(mx[0:][],2)+0.0054611*lag0(mx[0:][],3)+0.0095873*lag0(mx[0:][],4)-0.012714*lag0(mx[0:][],5)-0.061877*lag0(mx[0:][],6)-0.082968*lag0(mx[0:][],7)-0.12397*lag0(mx[0:][],8)-0.045143*lag0(mx[0:][],9)+0.018807*lag0(mx[0:][],10)-0.12487*lag0(mx[0:][],11)-0.25863*lag0(mx[0:][],12)-q);
	...
	for (j = 0; j<476; ++j)
	{
	s[j+12]= 0.00091974+0.094583*s[j+11]+0.030643*s[j+10]-0.0054611*s[j+9]-0.0095873*s[j+8]+0.012714*s[j+7]+0.061877*s[j+6]+0.082968*s[j+5]+0.12397*s[j+4]+0.045143*s[j+3]-0.018807*s[j+2]+0.12487*s[j+1]+0.25863*s[j]+P1[j+12];
	}																																			
	...
	savemat("G:\BOOTDATAAR.SWED.in7",mresults');
