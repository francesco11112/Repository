...
main()
{
	...
	q = meanc(mx[0:][0]-0.00042382*constant-0.28122*lag0(mx[0:][],1)+0.065874*lag0(mx[0:][],2)+0.046925*lag0(mx[0:][],3)-0.11733*lag0(mx[0:][],4)-0.066050*lag0(mx[0:][],5)-0.13057*lag0(mx[0:][],6)+0.029829*lag0(mx[0:][],7)+0.0040311*lag0(mx[0:][],8)-0.20597*lag0(mx[0:][],9)-0.0012787*lag0(mx[0:][],10)-0.0079630*lag0(mx[0:][],11)-0.21934*lag0(mx[0:][],12));
		
	U = (mx[0:][0]-0.00042382*constant-0.28122*lag0(mx[0:][],1)+0.065874*lag0(mx[0:][],2)+0.046925*lag0(mx[0:][],3)-0.11733*lag0(mx[0:][],4)-0.066050*lag0(mx[0:][],5)-0.13057*lag0(mx[0:][],6)+0.029829*lag0(mx[0:][],7)+0.0040311*lag0(mx[0:][],8)-0.20597*lag0(mx[0:][],9)-0.0012787*lag0(mx[0:][],10)-0.0079630*lag0(mx[0:][],11)-0.21934*lag0(mx[0:][],12)-q);
	...
	for (j = 0; j<476; ++j)
	{
	s[j+12]= 0.00042382+0.28122*s[j+11]-0.065874*s[j+10]-0.046925*s[j+9]+0.11733*s[j+8]+0.066050*s[j+7]+0.13057*s[j+6]-0.029829*s[j+5]-0.0040311*s[j+4]+0.20597*s[j+3]+0.0012787*s[j+2]+0.0079630*s[j+1]+0.21934*s[j]+P1[j+12];
	}																																			
	...
	savemat("G:\BOOTDATAAR.BEL.in7",mresults');
