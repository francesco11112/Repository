...
main()
{
	...
	q = meanc(mx[0:][0]- 0.0028995*constant+0.15713*lag0(mx[0:][],1)+0.17466*lag0(mx[0:][],2)+0.00094684*lag0(mx[0:][],3)-0.037728*lag0(mx[0:][],4)-0.066585*lag0(mx[0:][],5)-0.37970*lag0(mx[0:][],6)-0.13064*lag0(mx[0:][],7)-0.092139*lag0(mx[0:][],8)-0.039288*lag0(mx[0:][],9)+0.079357*lag0(mx[0:][],10)+0.00028380*lag0(mx[0:][],11)-0.32996*lag0(mx[0:][],12));
		
	U = (mx[0:][0]- 0.0028995*constant+0.15713*lag0(mx[0:][],1)+0.17466*lag0(mx[0:][],2)+0.00094684*lag0(mx[0:][],3)-0.037728*lag0(mx[0:][],4)-0.066585*lag0(mx[0:][],5)-0.37970*lag0(mx[0:][],6)-0.13064*lag0(mx[0:][],7)-0.092139*lag0(mx[0:][],8)-0.039288*lag0(mx[0:][],9)+0.079357*lag0(mx[0:][],10)+0.00028380*lag0(mx[0:][],11)-0.32996*lag0(mx[0:][],12)-q);
	...
	for (j = 0; j<476; ++j)
	{
	s[j+12]= 0.0028995-0.15713*s[j+11]-0.17466*s[j+10]-0.00094684*s[j+9]+0.037728*s[j+8]+0.066585*s[j+7]+0.37970*s[j+6]+0.13064*s[j+5]+0.092139*s[j+4]+0.039288*s[j+3]-0.079357*s[j+2]-0.00028380*s[j+1]+0.32996*s[j]+P1[j+12];
	}																																			
	...
	savemat("G:\BOOTDATAAR.GRE.in7",mresults');
