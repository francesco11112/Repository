...
main()
{
	...
	q = meanc(mx[0:][0]- 0.00098935*constant-0.21524*lag0(mx[0:][],1)+0.037548*lag0(mx[0:][],2)-0.041336*lag0(mx[0:][],3)-0.059245*lag0(mx[0:][],4)-0.0084617*lag0(mx[0:][],5)-0.14713*lag0(mx[0:][],6)+0.024915*lag0(mx[0:][],7)-0.16119*lag0(mx[0:][],8)-0.060894*lag0(mx[0:][],9)+0.030117*lag0(mx[0:][],10)-0.031912*lag0(mx[0:][],11)-0.22620*lag0(mx[0:][],12));
		
	U = (mx[0:][0]- 0.00098935*constant-0.21524*lag0(mx[0:][],1)+0.037548*lag0(mx[0:][],2)-0.041336*lag0(mx[0:][],3)-0.059245*lag0(mx[0:][],4)-0.0084617*lag0(mx[0:][],5)-0.14713*lag0(mx[0:][],6)+0.024915*lag0(mx[0:][],7)-0.16119*lag0(mx[0:][],8)-0.060894*lag0(mx[0:][],9)+0.030117*lag0(mx[0:][],10)-0.031912*lag0(mx[0:][],11)-0.22620*lag0(mx[0:][],12)-q);
	...
	for (j = 0; j<476; ++j)
	{
	s[j+12]= 0.00098935+0.21524*s[j+11]-0.037548*s[j+10]+0.041336*s[j+9]+0.059245*s[j+8]-0.0084617*s[j+7]+0.14713*s[j+6]-0.024915*s[j+5]+0.16119*s[j+4]+0.060894*s[j+3]-0.030117*s[j+2]+0.031912*s[j+1]+0.22620*s[j]+P1[j+12];
	}																																			
	...
	savemat("G:\BOOTDATAAR.SPAIN.in7",mresults');
