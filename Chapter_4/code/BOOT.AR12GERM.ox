...
main()
{
	...
	q = meanc(mx[0:][0]- 0.00054813*constant-0.20648*lag0(mx[0:][],1)+0.020167*lag0(mx[0:][],2)-0.094449*lag0(mx[0:][],3)+0.064920*lag0(mx[0:][],4)+0.027051*lag0(mx[0:][],5)-0.020964*lag0(mx[0:][],6)+0.0080193*lag0(mx[0:][],7)-0.030215*lag0(mx[0:][],8)-0.021490*lag0(mx[0:][],9)-0.080007*lag0(mx[0:][],10)+0.077158*lag0(mx[0:][],11)-0.38476*lag0(mx[0:][],12));
		
	U = (mx[0:][0]- 0.00054813*constant-0.20648*lag0(mx[0:][],1)+0.020167*lag0(mx[0:][],2)-0.094449*lag0(mx[0:][],3)+0.064920*lag0(mx[0:][],4)+0.027051*lag0(mx[0:][],5)-0.020964*lag0(mx[0:][],6)+0.0080193*lag0(mx[0:][],7)-0.030215*lag0(mx[0:][],8)-0.021490*lag0(mx[0:][],9)-0.080007*lag0(mx[0:][],10)+0.077158*lag0(mx[0:][],11)-0.38476*lag0(mx[0:][],12)-q);
	...
	for (j = 0; j<476; ++j)
	{
	s[j+12]= 0.00054813+0.20648*s[j+11]-0.020167*s[j+10]+0.094449*s[j+9]-0.064920*s[j+8]-0.027051*s[j+7]+0.020964*s[j+6]-0.0080193*s[j+5]+0.030215*s[j+4]+0.021490*s[j+3]+0.080007*s[j+2]+0.077158*s[j+1]+0.38476*s[j]+P1[j+12];
	}																																			
	...
	savemat("G:\BOOTDATAAR.GERM.in7",mresults');
