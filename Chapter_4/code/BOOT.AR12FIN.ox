...
main()
{
	...
	q = meanc(mx[0:][0]- 0.0016833*constant-0.033310*lag0(mx[0:][],1)-0.058020*lag0(mx[0:][],2)-0.15207*lag0(mx[0:][],3)+0.052215*lag0(mx[0:][],4)-0.092230*lag0(mx[0:][],5)-0.086456*lag0(mx[0:][],6)-0.020234*lag0(mx[0:][],7)-0.022321*lag0(mx[0:][],8)-0.11158*lag0(mx[0:][],9)+0.034715*lag0(mx[0:][],10)-0.024253*lag0(mx[0:][],11)-0.14201*lag0(mx[0:][],12));
		
	U = (mx[0:][0]- 0.0016833*constant-0.033310*lag0(mx[0:][],1)-0.058020*lag0(mx[0:][],2)-0.15207*lag0(mx[0:][],3)+0.052215*lag0(mx[0:][],4)-0.092230*lag0(mx[0:][],5)-0.086456*lag0(mx[0:][],6)-0.020234*lag0(mx[0:][],7)-0.022321*lag0(mx[0:][],8)-0.11158*lag0(mx[0:][],9)+0.034715*lag0(mx[0:][],10)-0.024253*lag0(mx[0:][],11)-0.14201*lag0(mx[0:][],12)-q);
	...
	for (j = 0; j<476; ++j)
	{
	s[j+12]= 0.0016833+0.033310*s[j+11]+0.058020*s[j+10]+0.15207*s[j+9]-0.052215*s[j+8]+0.092230*s[j+7]+0.086456*s[j+6]+0.020234*s[j+5]+0.022321*s[j+4]+0.11158*s[j+3]-0.034715*s[j+2]+0.024253*s[j+1]+0.14201*s[j]+P1[j+12];
	}																																			
	...
	savemat("G:\BOOTDATAAR.FIN.in7",mresults');
