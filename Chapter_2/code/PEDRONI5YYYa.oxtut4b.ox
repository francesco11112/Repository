...
main()
{
	...
	decl p = zeros(20,1);
	decl l = zeros(20,1);
	decl x = loadmat("G:\CH2-pedroniTESTDATA1.in7");	 // read in the data sets
    print("means:", meanc(x));
	

	decl dbase = new Database();		  // read in the data sets
    dbase.Load("G:\CH2-pedroniTESTDATA1.in7");	 // obtain database information
    dbase.Info();
