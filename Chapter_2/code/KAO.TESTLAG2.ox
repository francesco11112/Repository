...
{
{
		...
		decl DW,Fstat1,Fstat2,Fstat,amsval,DXX,R,Ra,Rb,R2,c1,PrimeGammaHat,mx,i,y,yHat,x1,x2,x3,x4,X,b,OLSbPlus,Delta1,Delta2,tPlus,Delta3,Delta4,tPlusPlus,T,amxinv,c,e1,e2,rho,rhoHat,Omega22Hatinv,t,w,d,p,q;
		...
		// load data-matrix
		mx=loadmat("G:\\KAO12.TestData5.in7");
