...
main()		 // This programme is for the panel data model with Cross-sectional Dependence
				//  7 Factors are estimated in this version
{
		...
		decl Z = zeros(39,0);
		// load data-matrix
		mx=loadmat("G:\\CHAPTER4-INF1.in7");
	...
	//initialising variables
		...
		IC =log(C2/780)+7*(59/780)*log(780/59);
		...
		println("POOLED FMOLS R2=",R2);
		println("POOLED FMOLS D.W.=",DW);
		println("POOLED FMOLS F-stat=",Fstat);
		println("POOLED FMOLS F-stat pval=",pval2);
