...
main()
{
		...
		decl DW,Fstat1,Fstat2,Fstat,amsval,DXX,R,Ra,Rb,R2,c1,c2,PrimeGammaHat,mx,i,y,yHat,x1,x2,x3,X,b,OLSbPlus,Delta1, Delta2,tPlus,T,amxinv,c,e1,e2,rho,rhoHat,Omega22Hatinv,t,w,d,p,q;

		println("FMOLS Consumption Function Estimates Using Income and Inflation.");
		decl xa,xb,ya,amsval2,amsvec2,F,Lambda,U,Zstar,YHAT,rhoHat2,X2,y2,b2,ba,F1,F2,F3,F4,F5,e,amx2inv,X1;
		decl eigen = zeros(39,39);
		decl Z = zeros(39,0);
		// load data-matrix
		mx=loadmat("G:\\CHAPTER5-INF1.in7");
	...
	//initialising variables
		...
		olsc(y,X1,&b,&amx2inv);	   // OLS estimation
	...
	//initialising variables
		...
		OLSbPlus=(YHAT'X-T*PrimeGammaHat)*amxinv;
